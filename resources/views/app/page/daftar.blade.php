        ...
        <div class="card-body ">
          ...
          <form method="POST" action="{{route('store.beasiswa')}}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="number" min="1" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" minlength="8" maxlength="14" name="no_hp" class="form-control" required>
             @error('no_hp')
              <div class="alert alert-danger mt-2">
                {{$message}}
              @enderror
            ...
            <div class="mb-3">
                ...
                <input type="text" name="ipk" id="ipk_terakhir" value="" class="form-control" readonly>
                @error('ipk')
                <div class="alert alert-danger mt-2">
                  {{$message}}
                @enderror
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="pilihan_beasiswa" aria-label="Default select example" name="jenis_beasiswa">
            ...
            <button type="submit" id="submit_btn" class="btn btn-primary">Daftar</button>
